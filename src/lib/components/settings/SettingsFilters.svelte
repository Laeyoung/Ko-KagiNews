...
<div class="space-y-6">
  ...
  <div class="flex items-center justify-between">
    ...
    <button
      ...
      class:bg-blue-600={contentFilter.showFilteredCount}
      class:bg-gray-200={!contentFilter.showFilteredCount}
      class:dark:bg-gray-600={!contentFilter.showFilteredCount}
    >
      <span
        class="inline-block h-4 w-4 transform rounded-full bg-white transition"
        class:ltr:translate-x-6={contentFilter.showFilteredCount}
        class:rtl:-translate-x-6={contentFilter.showFilteredCount}
        class:ltr:translate-x-1={!contentFilter.showFilteredCount}
        class:rtl:-translate-x-1={!contentFilter.showFilteredCount}
      ></span>
    </button>
  </div>
